 ...
 *
 * @Action(
 *   id = "views_file_delete",
 *   label = @Translation("Delete Files nida"),
 *   type = "",
 *   pass_view = TRUE
 * )
 */
class ViewsFileDelete extends ViewsBulkOperationsActionBase implements ContainerFactoryPluginInterface
{
  ...
  /**
   * Constructs a new ViewsFileDelete action.
   *
